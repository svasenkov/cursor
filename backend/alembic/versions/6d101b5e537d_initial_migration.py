...
def upgrade() -> None:
    ...
    sa.Column('name', sa.String(), nullable=False),  # Make required
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('title', sa.String(), nullable=False),  # Make required
    sa.Column('description', sa.String(), nullable=True),
    sa.Column('instructor', sa.String(), nullable=True),
    sa.Column('duration', sa.String(), nullable=True),
    sa.Column('price', sa.Float(), nullable=True),
    sa.Column('school_id', sa.Integer(), nullable=False),  # Make required
    sa.Column('platform_id', sa.Integer(), nullable=False),  # Make required
